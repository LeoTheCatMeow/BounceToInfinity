...
public class Sphere : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        tracker.eulerAngles += new Vector3(0f, MobileInput.screenDragDelta, 0f) * (1f + PlayerData.turnSensitivityPref);
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        if (Vector3.Distance(collision.GetContact(0).point, groundPoint.position) < groundPointDetectionTolerance && !grounded)
        {
            grounded = true;
            jumpReady = true;
